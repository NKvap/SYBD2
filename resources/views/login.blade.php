            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                <ul class="navbar-nav me-auto mb-2 mb-md-0">
                    <li class="nav-item dropdown"> <!-- Добавляем класс dropdown -->
                        <a class="nav-link dropdown-toggle active" aria-current="page" data-bs-toggle="dropdown" href="{{url('film')}}">Фильмы</a>
                        <ul class="dropdown-menu"> <!-- Добавляем класс dropdown-menu -->
                            <li><a class="dropdown-item" href="{{url('category')}}">Все категории</a></li>
                            <li><a class="dropdown-item" href="{{url('film')}}">Все фильмы</a></li>
                            <li><a class="dropdown-item" href="{{url('film/create')}}">Добавить фильм</a></li>
                            <li><hr class="dropdown-divider"></li>
                            <li><a class="dropdown-item" href="{{url('session')}}">Все сеансы</a></li>
                        </ul>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link text-white" href="{{url('ticket')}}">Билеты</a>
                    </li>
                </ul>
                @if(!Auth::user())
